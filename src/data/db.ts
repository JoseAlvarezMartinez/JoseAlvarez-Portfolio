...
export const experiencia: Experiencia[] = [
    {
        ...
        anio: 2021,
        descripcion: "Lidero proyectos centrados en el desarrollo de aplicaciones web utilizando tecnologías modernas como React. Mi enfoque principal es la creación de soluciones personalizadas para clientes en diversos sectores, incluidos blogs, aplicaciones de gestión de stock, plataformas de noticias deportivas y tiendas digitales."
    },
    {
        cargo: "Coderhouse",
        anio: 2022,
